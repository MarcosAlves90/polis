...
func TestChangelogContract(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"## [5.0.0] - 2026-08-30",
		"## [4.0.0] - 2026-08-29",
		"github.com/MarcosAlves90/polis/compare/v6.8.1...HEAD",
		"github.com/MarcosAlves90/polis/compare/v6.8.0...v6.8.1",
		"github.com/MarcosAlves90/polis/compare/v6.7.0...v6.8.0",
		"github.com/MarcosAlves90/polis/compare/v6.6.0...v6.7.0",
		"github.com/MarcosAlves90/polis/compare/v6.5.0...v6.6.0",
		"github.com/MarcosAlves90/polis/compare/v6.4.0...v6.5.0",
		"github.com/MarcosAlves90/polis/compare/v6.1.0...v6.2.0",
