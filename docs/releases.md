...
```bash
POLIS_GH="$HOME/tools/gh" ./scripts/github-release.sh --tag v6.2.0
```
...
```bash
./scripts/github-release.sh --tag v6.2.0 --publish
```
...
```bash
./scripts/github-release.sh --tag v6.2.0 --remote upstream
```
